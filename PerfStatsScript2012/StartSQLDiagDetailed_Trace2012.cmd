...
set SQLDIAGCMD=C:\Program Files\Microsoft SQL Server\110\Tools\Binn\SQLdiag.exe
"%SQLDIAGCMD%" /I "%cd%\SQLDiagPerfStats_Detailed_Trace2012.XML" /O "%cd%\SQLDiagOutput" /P
